...
export const config = {
  ...
  baseUrl: `https://agreements-accessibility-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `agreements-accessibility-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `agreements-accessibility-tests-${process.env.ENVIRONMENT}`
        },
